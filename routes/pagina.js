...
router.put('/:pagina_id',ensureAuthenticated, function (req, res){
    ...
    var datos = {
        ...
        pagina_telefono: req.body.pagina_telefono,
        pagina_direccion:req.body.pagina_direccion,
        pagina_email:    req.body.pagina_email,
        pagina_descripcion_larga: req.body.pagina_descripcion_larga,
        pagina_nosotros: req.body.pagina_nosotros,

        pagina_facebook:    req.body.pagina_facebook,
        pagina_twitter:     req.body.pagina_twitter,
        pagina_youtube:     req.body.pagina_youtube,
        pagina_google:      req.body.pagina_google,
        pagina_instagram:   req.body.pagina_instagram,
    };
    ...
    Pagina.owner(usuario_id, pagina_id, function (err, data) {
        if (err) {console.log(err);}
            ...
            var data = {
                ...
                galeria_nombre:         req.body.galeria_nombre,
                galeria_descripcion:      req.body.galeria_descripcion
            }
...
router.get('/:pagina_id/galeria/:galeria_id/imagenes',ensureAuthenticated, function (req, res){
    ...
    Pagina.getImagenes(galeria_id, function (err,data) {
        if (err) {console.log(err);
            res.send(500, { error: 'Ops! algo va mal' });
        } else{
            res.json(data);
        };
    });
...
router.put('/imagen/:imagen_id',ensureAuthenticated, function (req, res){
    ...
    var datos = {
        imagen_titulo: req.body.imagen_titulo,
        imagen_descripcion:req.body.imagen_descripcion
    };
            ...
            try {
                if(req.body.pagina_nombre){
                    ...
                    if (req.body.pagina_facebook_id) {
                        logo = "http://graph.facebook.com/"+req.body.pagina_facebook;
                    }
                }
                ...
                var datos = {
                    ...
                    pagina_dominio:req.body.pagina_dominio,
                    pagina_logo:logo,
                    pagina_portada:req.body.pagina_portada,            
                    pagina_descripcion: req.body.pagina_descripcion,
                    pagina_color: req.body.pagina_color,
                    pagina_tipo_id: req.body.pagina_tipo_id,
                    pagina_email: req.body.pagina_email,
                    pagina_direccion: req.body.pagina_direccion,
                    pagina_telefono: req.body.pagina_telefono,
                    pagina_facebook: req.body.pagina_facebook,                    
